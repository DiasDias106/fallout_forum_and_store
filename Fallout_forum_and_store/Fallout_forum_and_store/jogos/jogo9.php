...
<div class="con">
    ...
    <div class="product-page">
        ...
        <div class="product-details">
            ...
            <div class="btn-group">
                 <a class="btn" style="text-effect: none;color: white;" href="../alterarjogo.php?id_produto=9">Alteração do Produto</a>
    ...
    <div class="related-products">
        ...
        <div class="related-items">
            <div class="related-item">
                <img src="../imagens/falloutshelter_suple1.webp" height="150px" alt="Produto 1">
                <h3>70 Nuka-Cola Quantum</h3>
                <div class="price">€ 49,99</div>
            </div>
            <div class="related-item">
                <img src="../imagens/falloutshelter_suple2.webp" height="150px" alt="Produto 2">
                <h3>32 Nuka-Cola Quantum</h3>
                <div class="price">€ 19,99</div>
            </div>
            <div class="related-item">
                <img src="../imagens/falloutshelter_suple3.avif" height="150px" alt="Produto 3">
                <h3>400 Nuka-Cola Quantum</h3>
        ...
        <div style="margin-top: 50px">
            <div class="related-items">
                <div class="related-item">
                    <img src="../imagens/falloutshelter_suple4.webp" height="150px" alt="Produto 4">
                    <h3>1000 Nuka-Cola Quantum</h3>
                    <div class="price">€ 99,99</div>
                </div>
                <div class="related-item">
                    <img src="../imagens/falloutshelter_suple5.avif" height="150px" alt="Produto 5">
                    <h3>1 mascote</h3>
                    <div class="price">€ 4,99</div>
                </div>
                <div class="related-item">
                    <img src="../imagens/falloutshelter_suple6.webp" height="150px"  alt="Produto 6">
                    <h3>15 mascotes</h3>
