...
<div class="con">
    ...
    <div class="product-page">
        ...
        <div class="product-details">
            ...
            <div class="btn-group">
                 <a class="btn" style="text-effect: none;color: white;" href="../alterarjogo.php?id_produto=2">Alteração do Produto</a>
    ...
    <div class="related-products">
        ...
        <div class="related-items">
            <div class="related-item">
                <img src="../imagens/fallout4_dlc1.avif" height="150px" alt="Produto 1">
                <h3>Fallout 4: Automatron</h3>
                <div class="price">€ 4,99</div>
            </div>
            <div class="related-item">
                <img src="../imagens/Fallout4_dlc2.avif" height="150px" alt="Produto 2">
                <h3>Fallout 4: Contraptions</h3>
                <div class="price">€ 4,99</div>
            </div>
            <div class="related-item">
                <img src="../imagens/fallout4_dlc3.webp" height="150px" alt="Produto 3">
        ...
        <div style="margin-top: 50px">
            <div class="related-items">
                <div class="related-item">
                    <img src="../imagens/fallout4_dlc4.avif" height="150px" alt="Produto 4">
                    <h3>Fallout 4: Nuka-World</h3>
                    <div class="price">€ 14,99</div>
                </div>
                <div class="related-item">
                    <img src="../imagens/fallout4_dlc5.avif" height="150px" alt="Produto 5">
                    <h3>Fallout 4: Season Pass</h3>
                    <div class="price">€ 29,99</div>
                </div>
                <div class="related-item">
                    <img src="../imagens/fallout4_dlc6.avif" height="150px"  alt="Produto 6">
