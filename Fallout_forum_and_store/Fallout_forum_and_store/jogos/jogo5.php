...
<div class="con">
    ...
    <div class="product-page">
        ...
        <div class="product-details">
            ...
            <div class="btn-group">
                <a class="btn" style="text-effect: none;color: white;" href="../alterarjogo.php?id_produto=5">Alteração do Produto</a>
    ...
    <div class="related-products">
        ...
        <div class="related-items">
            <div class="related-item">
                <img src="../imagens/fallout3_dlc1.jpg" height="150px" alt="Produto 1">
                <h3>Fallout 3: Mothership ZETA</h3>
                <div class="price">€ 4,99</div>
            </div>
            <div class="related-item">
                <img src="../imagens/fallout3_dlc2.jpg" height="150px" alt="Produto 2">
                <h3>Fallout 3: Point Lookout</h3>
                <div class="price">€ 4,99</div>
            </div>
            <div class="related-item">
                <img src="../imagens/fallout3_dlc3.jpg" height="150px" alt="Produto 3">
                <h3>Fallout 3: Operation Anchorage</h3>
                <div class="price">€ 4,99</div>
            </div>
        </div>
        <div style="margin-top: 50px">
            <div class="related-items">
                <div class="related-item">
                    <img src="../imagens/fallout3_dlc4.jpg" height="150px" alt="Produto 4">
                    <h3>Fallout 3: Broken Steel</h3>
                    <div class="price">€ 4,99</div>
                </div>
                <div class="related-item">
                    <img src="../imagens/fallout3_dlc5.png" height="150px" alt="Produto 5">
                    <h3>Fallout 3: The Pitt</h3>
                    <div class="price">€ 4,99</div>
                </div>
            </div>
        </div>
