...
<div class="con">
    ...
    <div class="product-page">
        ...
        <div class="product-details">
            ...
            <div class="btn-group">
                 <a class="btn" style="text-effect: none;color: white;" href="../alterarjogo.php?id_produto=7">Alteração do Produto</a>
        ...
        try {
            $sql = "SELECT nome, imagem, preco, caminho FROM jogos WHERE id_jogo IN (1, 2, 5) LIMIT 4";
            $stmt = $pdo->query($sql);
