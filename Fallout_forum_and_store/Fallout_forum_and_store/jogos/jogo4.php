...
<div class="con">
    ...
    <div class="product-page">
        ...
        <div class="product-details">
            ...
            <div class="btn-group">
                 <a class="btn" style="text-effect: none;color: white;" href="../alterarjogo.php?id_produto=4">Alteração do Produto</a>
    ...
    <div class="related-products">
        ...
        <div class="related-items">
            <div class="related-item">
                <img src="../imagens/sup1_76.avif" height="150px" alt="Produto 1">
                <h3>1100 Atom points</h3>
                <div class="price">€ 14,99</div>
            </div>
            <div class="related-item">
                <img src="../imagens/sup2_76.avif" height="150px" alt="Produto 2">
                <h3>2400 Atom points</h3>
                <div class="price">€ 35,99</div>
            </div>
            <div class="related-item">
                <img src="../imagens/sup3_76.avif" height="150px" alt="Produto 3">
                <h3>5000 Atom points</h3>
        ...
        <div style="margin-top: 50px">
            <div class="related-items">
                <div class="related-item">
                    <img src="../imagens/sup4_76.avif" height="150px" alt="Produto 4">
                    <h3>500 Atom points</h3>
                    <div class="price">€ 4,99</div>
                </div>
                <div class="related-item">
                    <img src="../imagens/sup5_76.jpg" height="150px" alt="Produto 5">
                    <h3>1100 Atom points + bundle</h3>
                    <div class="price">€ 19,99</div>
                </div>
                <div class="related-item">
                    <img src="../imagens/sup6_76.avif" height="150px"  alt="Produto 6">
                    <h3>12 meses de membership</h3>
