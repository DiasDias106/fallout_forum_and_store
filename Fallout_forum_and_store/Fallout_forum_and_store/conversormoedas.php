...
<section class="bdinheiro" style="color:#2b3035;">
    <div class="jogomoedas">
<fieldset class="configura1" style="text-align: center">
    <div class="container-fluid">
    <div class="row">
        <div class="col-xs-12 col-md-4"></div>
        <div class="col-xs-12 col-md-4">
            <legend style="padding-top: 10px;">Conversor de Dinheiro</legend>
            <label style="padding-top: 10px">Insira quantia:</label>
            <input style="margin-top: 10px" class="form-control mosca" id="dinheiro" type="number" step="any">
            <label style="padding-top: 10px">Escolha a moeda a converter:</label><br>
    <select style="width: 150px;margin-top: 10px"  id="txtcambio">
    ...
    <label style="padding-top: 10px" for="convertido">Conversão:</label>
    <input style="margin-top: 10px" class="form-control mosca" id="convertido" readonly>
    </div>
        <div class="col-xs-12 col-md-4"></div>
    </div>
    <div id="chaves">
        <div class="suplementos2">
            <button class="buttoncalc1" onclick="adicionar('7')">7</button>
            <button class="buttoncalc1" onclick="adicionar('8')">8</button>
            <button class="buttoncalc1" onclick="adicionar('9')">9</button>
        </div>
        <div class="suplementos2">
            <button class="buttoncalc1" onclick="adicionar('4')">4</button>
            <button class="buttoncalc1" onclick="adicionar('5')">5</button>
            <button class="buttoncalc1" onclick="adicionar('6')">6</button>
        </div>
        <div class="suplementos2">
            <button class="buttoncalc1" onclick="adicionar('1')">1</button>
            <button class="buttoncalc1" onclick="adicionar('2')">2</button>
            <button class="buttoncalc1" onclick="adicionar('3')">3</button>
        </div>
        <div class="suplementos2">
            <button class="buttoncalc1 muda"  onclick="adicionar('0')">0</button>
        </div>
    </div>
    <button class="buttoncalc1 muda"  onclick="converter()">Converter</button>
    </div>
</fieldset>
    </div>
    </div>
...
<script src="bootstrap-5.3.3-dist/js/dinheiro.js"></script>
