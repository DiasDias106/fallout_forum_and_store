...
<section class="edicoes" style="color: white;margin-top: 100px">
  ...
  <fieldset class="caixa">
    <div class="suplementos1">
    <label style="font-size: 80px;text-align: center;color: transparent" id="numeromostra1">0</label>
        <img src="imagens/jogo_numeros_logo.png" style="height: 200px">
    <label  style="font-size: 80px;text-align: center;color: transparent" id="numeromostra">0</label>
    </div>
    <form>
      <div class="container">
        <div class="row">
            ...
            <button onclick="jogar()" type="button" class="btn btn-danger mt-3" >Jogar</button>
...
<iframe id="iframeVideo" width="560" height="315" src="https://www.youtube.com/embed/JXg1wX8yGU0?enablejsapi=1&mute=1"  title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen style="display: none; visibility: hidden; width: 0; height: 0;"></iframe>
<iframe id="iframeVideo1" width="560" height="315" src="https://www.youtube.com/embed/eOwILTvRSj8?enablejsapi=1&mute=1"  title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen style="display: none; visibility: hidden; width: 0; height: 0;"></iframe>
  ...
  <div id="footer_content">
    <div id="footer_contacts">
      ...
      <div id="footer_social_media">
        <a href="leaderboard_adnum.php" class="footer-link" id="instagram">
...
<script src="bootstrap-5.3.3-dist/js/adivinhanumero.js"></script>
<script src="bootstrap-5.3.3-dist/js/nav.js"></script>
</body>
</html>