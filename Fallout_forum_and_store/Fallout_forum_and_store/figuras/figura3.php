...
<div class="con">
    ...
    <div class="product-page">
        ...
        <div class="product-details">
            ...
            <div class="btn-group">
                  <a class="btn" style="text-effect: none;color: white;" href="../alterarfigura.php?id_produto=3">Alteração do Produto</a>
        ...
        try {
            $sql = "SELECT nome, imagem, preco, caminho FROM figuras WHERE id_figura IN (2, 4, 7) ";
            $stmt = $pdo->query($sql);
