...
<div class="con">
    ...
    <div class="product-page">
        ...
        <div class="product-details">
            ...
            <div class="btn-group">
                  <a class="btn" style="text-effect: none;color: white;" href="../alterarfigura.php?id_produto=2">Alteração do Produto</a>
        ...
        try {
            $sql = "SELECT nome, imagem, preco, caminho FROM figuras WHERE id_figura IN (1, 8, 6) order by id_figura desc";
            $stmt = $pdo->query($sql);
