...
include '../cnn1.php';
$id = 1;
$sql = "SELECT nome, preco , quantidade, descricao, imagem FROM figuras WHERE id_figura = :id";
try {
...
$sql_estoque = "UPDATE figuras SET quantidade = quantidade - :quantidade WHERE id_figura = :id";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['eliminar_produto'])) {
    ...
    try {
        $sql = "DELETE FROM figuras WHERE id_figura = :id";
        $stmt = $pdo->prepare($sql);
...
<div class="con">
    ...
    <div class="product-page">
        <div class="product-images">
            <img src="<?php echo $caminho_imagem; ?>" class="card-img-top" style="height:400px;width: 400px" alt="Imagem do Produto">
        </div>
        ...
        <div class="product-details">
            ...
            <div class="btn-group">
                 <a class="btn" style="text-effect: none;color: white;" href="../alterarfigura.php?id_produto=1">Alteração do Produto</a>
        ...
        try {
            $sql = "SELECT nome, imagem, preco, caminho FROM figuras WHERE id_figura IN (3, 5, 8) LIMIT 4";
            $stmt = $pdo->query($sql);
