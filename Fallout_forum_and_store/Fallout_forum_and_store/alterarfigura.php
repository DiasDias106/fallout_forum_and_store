...
if ($id_produto) {
    try {
        $stmt = $pdo->prepare("SELECT * FROM figuras WHERE id_figura = ?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['alterar_produto'])) {
    ...
    try {
        $sql = "UPDATE figuras SET nome = ?, quantidade = ?, preco = ?, descricao = ?, imagem = ? WHERE id_figura = ?";
...
<div class="container">
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <a href="figuras.php" style="margin-top: 20px" class="btn btn-secondary">Cancelar</a>
        </div>
    </form>
</div>
