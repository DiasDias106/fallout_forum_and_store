    ...
    <div class="product-details">
      ...
      <p class="product-description">
        ...
        if (isset($_SESSION['cargo']) && $_SESSION['cargo'] === 'admin') {
            ...
            <div class="btn-group">
                <a class="btn" style="text-effect: none;color: white;" href="../alteraroutro.php?id_produto=4">Alteração do Produto</a>
        ...
        try {
            $sql = "SELECT nome, imagem, preco, caminho FROM outros WHERE id_outros IN (1, 2, 3) LIMIT 4";
            $stmt = $pdo->query($sql);
