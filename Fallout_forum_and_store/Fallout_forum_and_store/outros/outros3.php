...
<div class="con">
    ...
    <div class="product-page">
        ...
        <div class="product-details">
            ...
            <div class="btn-group">
               <a class="btn" style="text-effect: none;color: white;" href="../alteraroutro.php?id_produto=3">Alteração do Produto</a>
        ...
        try {
            $sql = "SELECT nome, imagem, preco, caminho FROM outros WHERE id_outros IN (4, 7, 9) order by id_outros desc";
            $stmt = $pdo->query($sql);
