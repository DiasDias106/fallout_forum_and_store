...
if ($id_produto) {
    try {
        $stmt = $pdo->prepare("SELECT * FROM jogos WHERE id_jogo = ?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['alterar_produto'])) {
    ...
    try {
        $sql = "UPDATE jogos SET nome = ?, quantidade = ?, preco = ?, descricao = ?, imagem = ? WHERE id_jogo = ?";
...
<div class="container">
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <a href="jogos.php" style="margin-top: 20px" class="btn btn-secondary">Cancelar</a>
        </div>
    </form>
</div>
