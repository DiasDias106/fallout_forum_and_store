...
<section class="bcforca">
    ...
    <h2 class="message"></h2>
    <button class="forcab" onclick="iniciarjogo()">Reiniciar</button>
    </div>
</section>
    ...
    <div id="footer_content">
        <div id="footer_contacts">
            ...
            <div id="footer_social_media">
                <a href="leaderboard_forca.php" class="footer-link" id="instagram">
...
<script src="bootstrap-5.3.3-dist/js/forca.js"></script>
