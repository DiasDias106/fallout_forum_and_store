    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (isset($_FILES['imagem']) && $_FILES['imagem']['error'] == UPLOAD_ERR_OK) {
            ...
            if (move_uploaded_file($_FILES['imagem']['tmp_name'], $target_file)) {
                $sql = "INSERT INTO figuras (nome, descricao, caminho, preco, imagem) 
...
<div class="container">
    ...
    <form action="adicionarfigura.php" method="post" enctype="multipart/form-data">
        ...
        <button type="button" class="cancel-button" onclick="window.location.href='figuras.php';">Voltar à Loja</button>
    </form>
</div>
</body>
</html>
